...
document.getElementById("file").onchange = function(e) {
  ...
  document.getElementById("fileMarca").onchange = function(e) {
    // Creamos el objeto de la clase FileReader
    let reader = new FileReader();
    ...
    // Le decimos que cuando este listo ejecute el código interno
    reader.onload = function(){
        let preview = document.getElementById('previewMarca')
  ...
  document.getElementById("fileColor").onchange = function(e) {
    // Creamos el objeto de la clase FileReader
    let reader = new FileReader();
    ...
    // Le decimos que cuando este listo ejecute el código interno
    reader.onload = function(){
        let preview = document.getElementById('previewColor')
